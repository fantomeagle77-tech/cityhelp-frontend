  ...
  return (
    <div className="layout">
      ...
      <div className="map-wrapper">
		...
		<div style={{ position:"absolute", left:20, bottom:90, maxWidth:420, background:"rgba(255,255,255,0.9)", padding:"10px 12px", borderRadius:12, zIndex:1000 }}>
		  <div style={{ fontWeight:700, marginBottom:4 }}>Городской мониторинг домов</div>
