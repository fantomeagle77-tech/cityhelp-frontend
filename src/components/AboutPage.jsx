        ...
        <div className="contact-row">
          ...
          <div style={{ marginTop: 16 }}>
            <a
              ...
              rel="noreferrer"
            >
              Поддержать / сотрудничество
            </a>
          </div>
          
          <div className="contact-note">
            CityHelp — частный независимый проект. Если вы хотите поддержать развитие сервиса, предложить сотрудничество, 
            партнёрство или рекламу, напишите в Telegram.
          </div>
